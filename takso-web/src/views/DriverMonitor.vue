              ...
              >
                <template slot="items" slot-scope="props">
                  ...
                  <td class="text-xs-right">
                    <v-btn v-if="props.item.transaction_status === 'accepted'" @click="journeyComplete(props.item.id, '2.2 km', props.item.customer_id)" color="info">Close Transaction</v-btn>
...
<script>
  export default {
    ...
    methods: {
        ...
        journeyComplete(id, distance, customerid){
          let idObjects =  
                {
                    "booking": {
                      "id": id,
